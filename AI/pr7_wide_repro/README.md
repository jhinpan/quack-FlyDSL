...
| --- | --- | ---: | ---: | ---: | ---: |
| `mia1-p02-g23` | forward | 2.448 ms | 2.392 ms | 0.977x | 0.993 |
| `smci355-ccs-aus-n08-09` | forward | 2.576 ms | 2.425 ms | 0.941x | 1.004 |
| `mia1-p02-g23` | backward | 3.957 ms | 5.206 ms | 1.316x | 0.998 |
| `smci355-ccs-aus-n08-09` | backward | 4.162 ms | 5.409 ms | 1.299x | 1.005 |
...
6.80/6.75 TB/s and 6.47/6.50 TB/s respectively, with less than 0.7% drift.
