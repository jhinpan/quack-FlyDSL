...
> A `copy_` probe measures 1.30x inflation at the boundary (1.324x at 64 MiB
> buffers, 1.298x at 16 MiB), reproduced by a
> second reviewer re-running the committed probe. **That 1.30x is a property of
